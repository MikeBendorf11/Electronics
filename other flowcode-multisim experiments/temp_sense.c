//************************************************************************************
//**  
//**  File name:     G:\bcit_flowcode_projecs\temp_sense.c
//**  Title:         
//**  Description:   
//**  
//**  Generated by:  Flowcode v5.5.2.1
//**  Date:          Monday, August 11, 2014 11:03:46
//**  Licence:       50 User
...
******************************/
	...
	#define LCD_2__PORT0    latc
	#define LCD_2__PORT1    latc
	#define LCD_2__PORT2    latc
	#define LCD_2__PORT3    latc
	#define LCD_2__PORT4    latc
	#define LCD_2__PORT5    latc
   #else
	 ...
	 #define LCD_2__PORT5    latc
    #else
	 #define LCD_2__PORT0    portc
	 #define LCD_2__PORT1    portc
	 #define LCD_2__PORT2    portc
	 #define LCD_2__PORT3    portc
	...
	#define LCD_2__TRIS0    trisc
	#define LCD_2__TRIS1    trisc
	#define LCD_2__TRIS2    trisc
	#define LCD_2__TRIS3    trisc
