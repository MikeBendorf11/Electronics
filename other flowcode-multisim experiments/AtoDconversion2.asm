...
CompTempVar2230                  EQU	0x0000004C ; bytes:1
CompTempVar2233                  EQU	0x00000050 ; bytes:1
CompTempVar2236                  EQU	0x00000050 ; bytes:1
CompTempVar2237                  EQU	0x00000051 ; bytes:1
CompTempVar2240                  EQU	0x0000004C ; bytes:1
CompTempVar2241                  EQU	0x00000050 ; bytes:1
CompTempVar2242                  EQU	0x00000051 ; bytes:1
CompTempVar2245                  EQU	0x0000004C ; bytes:1
CompTempVar2246                  EQU	0x00000050 ; bytes:1
CompTempVar2247                  EQU	0x00000051 ; bytes:1
...
label11
	...
	RRF CompTempVar2198, F
	SWAPF CompTempVar2198, F
	MOVLW 0x03
...
label15
	...
	RLF CompTempVar2191, F
	MOVLW 0xC0
	ANDWF CompTempVar2190, W
	IORLW 0x01
	MOVWF CompTempVar2194
	MOVF FC_CAL_Ena_00051_arg_Channel, W
	MOVWF CompTempVar2193
	RLF CompTempVar2193, F
	RLF CompTempVar2193, F
	RLF CompTempVar2193, F
	MOVLW 0xF8
	ANDWF CompTempVar2193, W
...
label33
	...
	BTFSS CompTempVar2247,0
	GOTO	label34
	COMF CompTempVar2246, F
